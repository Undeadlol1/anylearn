...
<p>Если ученик не знает зачем обучаться какому-либо навыку, значит он ему и не нужен. Это концепция проста и эффективна, так как если в навык есть необходимость, ученики учатся с бОльшей заинтересованностью, а учителям проще формулировать рекомендации, основанные на реальном применении, а не на расплывчатых теориях.</p>`
...
<h2>Требования к ученику</h2>
<p>Чтобы освоить некоторые навыки необходимо выполнить какие-либо требования или иметь определенный набор навыков. Например, прежде чем учиться чинить современные спорт кары, нужно научиться чинить обычные автомобили, изучить строение типичного двигателя и так далее.</p>
<p>Если у этого навыка нет требовний или они незначительны, то эту секцию можно смело удалить.</p>
<h2>Альтернативы</h2>
<b>
...
`
export const third = `<i><b>Примечание сервиса:</b></i>
${descriptions[2]}
...
`
export const fourth =`<i><b>Примечание сервиса:</b></i>
${descriptions[3]}
